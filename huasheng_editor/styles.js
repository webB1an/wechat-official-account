...
const STYLES = {
  'wechat-default': {
    name: '默认公众号风格',
    styles: {
      container: 'max-width: 740px; margin: 0 auto; padding: 10px 12px 20px 12px; font-family: -apple-system, BlinkMacSystemFont, "PingFang SC", "Noto Sans SC", "Microsoft YaHei", "Segoe UI", Roboto, "Helvetica Neue", Arial, sans-serif; font-size: 15px; line-height: 1.85 !important; letter-spacing: 0.5px; color: #3f3f3f !important; background-color: #fff !important; word-wrap: break-word;',
      h1: 'font-size: 20px; font-weight: 600; color: #2c3e50 !important; line-height: 1.45 !important; letter-spacing: 0.5px; margin: 30px 0 14px; padding-bottom: 8px; border-bottom: 2px solid #3498db;',
      h2: 'font-size: 18px; font-weight: 600; color: #2c3e50 !important; line-height: 1.5 !important; letter-spacing: 0.5px; margin: 26px 0 12px; padding-left: 12px; border-left: 4px solid #3498db;',
      h3: 'font-size: 18px; font-weight: 600; color: #34495e !important; line-height: 1.5 !important; letter-spacing: 0.5px; margin: 22px 0 10px;',
      h4: 'font-size: 17px; font-weight: 600; color: #34495e !important; line-height: 1.5 !important; letter-spacing: 0.5px; margin: 20px 0 10px;',
      h5: 'font-size: 16px; font-weight: 600; color: #34495e !important; line-height: 1.5 !important; letter-spacing: 0.5px; margin: 18px 0 9px;',
      h6: 'font-size: 15px; font-weight: 600; color: #34495e !important; line-height: 1.5 !important; letter-spacing: 0.5px; margin: 16px 0 8px;',
      p: 'margin: 16px 0 !important; line-height: 1.85 !important; letter-spacing: 0.5px; color: #3f3f3f !important;',
      ...
      li: 'margin: 8px 0; line-height: 1.85 !important; letter-spacing: 0.5px;',
